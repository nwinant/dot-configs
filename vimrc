...
""  Enable mouse support in NORMAL and VISUAL modes. This swallows 
""  click-to-paste, so it's disabled in INSERT mode. Mouse support 
...
"" 
""  Press \w to toggle wrapping on or off. When wrap is on, the cursor movement
""  keys are mapped to move by display lines.
